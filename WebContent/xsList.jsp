...
<div class="layui-layout layui-layout-admin">
  ...
  <div class="layui-body">
    <!-- 内容主体区域 -->
   <h1 style="margin-left: 600px;padding-top:70px;">修改学员信息</h1><br/><br/><br/>
		...
		<table border="1px" rules="all" style="font-size:50;margin-left: 100px;width:80%;">
			...
			<s:iterator var="xss" value="#request.xsList" status="ids">
				<tr style="font-size:20px;text-align:center;">
					...
					<td style="font-size:25px;">
						&nbsp;<a href="xsAction_toUpdateStu?xs.xsno=${xss.xsno }" class="t" style="color:green;">修改</a>&nbsp;
					</td>
					<td style="font-size:25px;">
						&nbsp;<a href="xsAction_deleteStu?xs.xsno=${xss.xsno}" class="t" style="color:red;">&nbsp;删除</a>&nbsp;
					</td>
				</tr>
			</s:iterator>
		</table>
